...
class RecordingRepository {
    ...
    async insert({ phaseId, storagePath, mimeType, durationSeconds, fileSizeBytes }) {
    ...
    async getById(id) {
        return (await this._db.prepare('SELECT * FROM recordings WHERE id = ?').get(id)) || null;
    }
